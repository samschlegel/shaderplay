namespace ComputeShaderUtility
{
	...
	public static class ComputeHelper
	{
		...
		public const GraphicsFormat
			defaultGraphicsFormat = GraphicsFormat.R16G16B16A16_SFloat; //GraphicsFormat.R8G8B8A8_UNorm;
		...
		public static void NormalizeRenderTexture(RenderTexture source)
		{
			...
			ComputeBuffer minMaxBuffer = CreateAndSetBuffer<int>(new int[] {int.MaxValue, 0}, normalizeTextureCompute,
				"minMaxBuffer", 0);
		...
		public static void SetParams(System.Object settings, ComputeShader shader, string variableNamePrefix = "",
			string variableNameSuffix = "")
		{
			...
			foreach (var field in fields)
			{
				...
				if (fieldType == typeof(UnityEngine.Vector4) || fieldType == typeof(Vector3) ||
